...
//     const c = n - i - 1;
//     if (c === 1) {
//       res = `${res} + ${arguments[i]} * x`;
//     } else if (c > 1) {
//       res = `${res} + ${arguments[i]} * x ** ${n - i - 1}`;
//     } else {
//       res = `${res} + ${arguments[i]}`;
//     }
//   }
...
function logger(func, logFunc) {
  return (...args) => {
    ...
    const str = stringifiedArgs.join(',');
...
//   throw new Error('Not implemented');
// }
function partialUsingArguments(fn, ...arguments1) {
  return function newF(...arguments2) {
    return fn(...arguments1, ...arguments2);
  };
}
